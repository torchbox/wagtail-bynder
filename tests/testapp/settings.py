...
BYNDER_IMAGE_SOURCE_THUMBNAIL_NAME = env.get("BYNDER_IMAGE_SOURCE_THUMBNAIL_NAME", None)
...
BYNDER_VIDEO_PRIMARY_DERIVATIVE_NAME = env.get(
    "BYNDER_VIDEO_PRIMARY_DERIVATIVE_NAME", "Derivative-1"
)
BYNDER_VIDEO_FALLBACK_DERIVATIVE_NAME = env.get(
    "BYNDER_VIDEO_FALLBACK_DERIVATIVE_NAME", "Derivative-2"
)
